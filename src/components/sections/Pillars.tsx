        ...
        {pillars.map((p, i) => (
          ...
          >
            ...
            <div className="relative h-48 overflow-hidden">
              ...
              <span className="absolute top-4 right-4 text-[10px] uppercase tracking-widest text-foreground/90 backdrop-blur-md bg-background/40 border border-border/60 rounded-full px-2.5 py-1">
                {p.tag}
              </span>
              <div className={`absolute bottom-4 left-4 grid size-12 place-items-center rounded-xl bg-gradient-to-br ${p.accent} text-primary-foreground shadow-glow`}>
